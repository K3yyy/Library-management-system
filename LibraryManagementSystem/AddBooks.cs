...
namespace LibraryManagementSystem
{
    public partial class AddBooks : UserControl
    {
        ...
        SqlConnection connect = new SqlConnection(@"Data Source=KEYY;Initial Catalog=library;Integrated Security=True");
        public AddBooks()
        {
            InitializeComponent();
            displayBooks();
            ...
            else
            {
                try
                {
                    if (connect.State == ConnectionState.Closed)
                    {
                        ...
                        string path = Path.Combine(@"C:\Users\keyyBook\Source\Repos\Library-Management-System-using-CSharp\LibraryManagementSystem\LibraryManagementSystem\Books_Directory\",
